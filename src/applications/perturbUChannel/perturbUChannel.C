...
License
    ...
    Free Softare Foundation; either version 2 of the License, or (at your
...
#   include "createMesh.H"
    ...
    dimensionedVector Ubar("Ubar", dimVelocity, transportProperties);
    ...
    volVectorField Plus(PlusHeader, mesh);
    ...
    forAll(centres, celli)
    {
        ...
        Plus[celli][streamDir] = xplus;
        Plus[celli][heightDir] = yplus;
        Plus[celli][spanDir] = zplus;

    }   

    Info<< "Writing Plus" << endl;
    Plus.write();
    */
    return(0);
}
